...
<head>
    ...
    <title>Login - Moon Texmach</title>
    <link rel="icon" type="image/x-icon" href="{{ asset('frontend/images/resources/logo.jpg') }}" />
    ...
    <style>
        ...
        body {
            background: url('../backend/images/login.jpg');
                    ...
                    <div class="form-content">
                        ...
                        <div class="row text-center">
                            <div class="col col-12">
                                <a href="/">
                                    <img src="{{ asset('frontend/images/resources/logo.jpg') }}" width="30%"
                                        class="" alt="logo">
                                </a>
                            </div>
